...
### 19 Jan 2024
* *4 hours* Add new functions to the python script for running ChatGPT & Implement the helper function that makes the python script runnable from Java
* *0.5 hours* Supervisor meeting
* *1 hour* Summarising the meeting, uploading the meeting minutes for past meetings and update the time log

### 20 Jan 2024
* *0.5 hours* Figure out what is the problem with ChatGPT not working
* *0.5 hours* Solving the load_dotenv() not updating env variables error
* *0.5 hours* Looking at the LLM results
* *1.5 hours* Change the structure of the JSON generated by the python script performing the prompting
* *0.5 hours* Make the python LLM prompting script runnable from Java using the virtual environment
* *2 hours* Trying to get the sonarqube api to return the evaluation metrics

### 21 Jan 2024
* *2 hour* Solving the sonarqube api 403 error

## Week 18
### 23 Jan 2024
* *1 hour* Rewrite the get request to use the username and password header
* *0.5 hours* Work on the eval function

### 25 Jan 2024
* *0.5 hours* Get simple refactorings only function
